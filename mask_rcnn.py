...
# 모델 & 설정 파일
model = 'D:\opnecv\ch13\mask_rcnn\frozen_inference_graph.pb'
config = 'FD:\opnecv\ch13\mask_rcnn\mask_rcnn_inception_v2_coco_2018_01_28.pbtxt.txt'
class_labels = 'D:\opnecv\ch13\mask_rcnn\coco.names'
confThreshold = 0.6
maskThreshold = 0.3
